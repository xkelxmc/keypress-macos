...
struct StudioStrings: Equatable, Sendable {
    ...
    private static let english: [String: String] = [
        ...
        "keyboard.commandZone": "Command Zone",
        "keyboard.commandZone.side": "Command Zone Side",
        "keyboard.commandZone.side.auto": "Auto",
        "keyboard.commandZone.side.left": "Left",
        "keyboard.commandZone.side.right": "Right",
        "keyboard.commandZone.side.subtitle": "Which side shortcuts line up with under the text ribbon.",
        ...
        "keyboard.inputKeys.width.subtitle": "How wide Space, Enter, Backspace, and Tab appear.",
