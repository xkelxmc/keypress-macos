...
struct StudioStrings: Equatable, Sendable {
    ...
    private static let english: [String: String] = [
        ...
        "about.release21.command.body":
            "Shortcuts and system keys get their own block, with a repeat counter (⌘V ×3) "
            + "and their own position on screen.",
        "about.release21.command.title": "Command Zone",
        "about.release21.echo.body":
            "Stacked history now shows the typed text itself, large and readable. Backspace truly erases, "
            + "and nothing that left the screen comes back.",
        "about.release21.echo.title": "Text Echo",
        "about.release21.motion.body":
            "The overlay rises in and settles out as one solid piece, without stutter on any display.",
        "about.release21.motion.title": "Refined Motion",
        "about.release21.ribbon.body":
            "Keys appear in exact typing order with Shift and Caps Lock casing, and the ribbon’s conveyor "
            + "keeps pace with how fast you type.",
        "about.release21.ribbon.title": "Typing Ribbon",
        "about.release21.title": "What’s New in 2.1",
        "about.highlights.title": "Keypress 2 Highlights",
        ...
        "general.enabled.subtitle": "Master switch for keyboard, pointer, and pet overlays.",
        ...
        "keyboard.echo.idleTimeout": "Clear After Pause",
        "keyboard.echo.idleTimeout.subtitle": "Idle time before the text clears.",
        "keyboard.echo.lineLifetime": "Line Lifetime",
        "keyboard.echo.lineLifetime.subtitle": "How long finished lines stay while you keep typing.",
        "keyboard.inputKeys": "Input Keys",
        "keyboard.inputKeys.tint": "Tint Space, Enter, Backspace & Tab",
        "keyboard.inputKeys.tint.subtitle": "Give them a slightly different tone from letter keys.",
        "keyboard.inputKeys.width": "Width",
        "keyboard.inputKeys.width.custom": "Custom",
        "keyboard.inputKeys.width.narrow": "Narrow",
        "keyboard.inputKeys.width.subtitle": "How wide Space, Enter, Backspace and Tab render as keycaps.",
        "keyboard.inputKeys.width.wide": "Wide",
        ...
        "keyboard.filter.functions.subtitle": "Show F1–F20 presses.",
        ...
        "keyboard.filter.special.subtitle": "Show Escape, arrows, Backspace, Space, Enter and Tab.",
        "keyboard.filters": "Filters",
        "keyboard.history": "History",
        "keyboard.maxKeys": "Maximum Keys",
        "keyboard.maxKeys.subtitle": "How many keycaps the ribbon holds.",
        "keyboard.mode": "Display Mode",
        "keyboard.mode.subtitle": "Latest combo, a ribbon of keys, or an echo of the text you type.",
        "keyboard.subtitle": "Choose which keys appear and how they behave.",
        "keyboard.timeout": "Key Timeout",
        "keyboard.timeout.subtitle": "How long released keys stay visible in the key zones.",
        ...
        "onboarding.pet.disabled": "Pet is disabled — you can still finish setup",
        "onboarding.pet.hint": "Type, move the pointer, or click the cat",
        "onboarding.pet.hint.click": "Type or click the cat",
        "onboarding.pet.hint.pointer": "Type or move the pointer",
        "onboarding.pet.hint.typing": "Keep typing to animate the pet",
        "onboarding.pet.subtitle": "A small companion that follows the rhythm of your work.",
        "onboarding.pet.title": "Meet your typing companion",
        "onboarding.pet.waiting": "Start typing to bring the pet on screen",
        ...
        "onboarding.step.5": "Pet",
        "pet.activityMode": "Activity Order",
        "pet.activityMode.cycle": "Cycle",
        "pet.activityMode.random": "Random",
        "pet.activityMode.subtitle": "Choose a predictable sequence or varied activities.",
        "pet.cursor": "Cursor",
        "pet.enabled": "Keypress Pet",
        "pet.enabled.subtitle": "Show an animated companion on your screen.",
        "pet.groom": "Groom",
        "pet.groom.subtitle": "Occasionally stop to clean up.",
        "pet.huntCursor": "Hunt Cursor",
        "pet.huntCursor.subtitle": "Pounce at fast nearby pointer movement.",
        "pet.interaction": "Interaction",
        "pet.petReaction": "React to Clicks",
        "pet.petReaction.subtitle": "Respond when you click the cat.",
        "pet.playTail": "Play with Tail",
        "pet.playTail.subtitle": "Occasionally get distracted by its own tail.",
        "pet.position": "Screen Position",
        "pet.position.moveDown": "Move Down",
        "pet.position.moveLeft": "Move Left",
        "pet.position.moveRight": "Move Right",
        "pet.position.moveUp": "Move Up",
        "pet.position.reset": "Reset Position",
        "pet.position.subtitle": "Drag the cat directly on screen to move it.",
        "pet.presentation": "Presentation",
        "pet.preview.off": "Pet Off",
        "pet.preview.typing": "The pet appears here while you type",
        "pet.routine": "Daily Routine",
        "pet.size": "Pet Size",
        "pet.size.subtitle": "Set how large the cat appears on screen.",
        "pet.sleep": "Sleep",
        "pet.sleep.subtitle": "Fall asleep after a longer idle period.",
        "pet.stretch": "Stretch",
        "pet.stretch.subtitle": "Occasionally stretch after sitting still.",
        "pet.subtitle": "Choose when your cat appears and which habits stay active.",
        "pet.title": "Pet",
        "pet.typingOnly.behaviorHint": "Idle, cursor, and click behaviors require Always visibility.",
        "pet.visibility": "Visibility",
        "pet.visibility.always": "Always",
        "pet.visibility.subtitle": "Keep the cat around or show it only while typing.",
        "pet.visibility.typing": "While Typing",
        "pet.watchCursor": "Watch Cursor",
        "pet.watchCursor.subtitle": "Follow pointer movement with its eyes and head.",
        ...
        "position.editor.subtitle.zones": "%@ · Drag each zone into place, then click Done.",
